...
export const zhCN: Translations = {
  ...
  topicWatches: {
    title: "Topic Watch",
    description:
      "创建研究 watch，显式配置 query terms、seed papers、模板族和调度预设。",
    createTitle: "创建 Topic Watch",
    createDescription:
      "先把最小控制对象建起来，后续 ingest 和 analysis 才有稳定入口。",
    boardTitle: "Topic Watch Board",
    boardDescription: "查看当前用户已经持久化的研究 watch。",
    queryTerms: "查询词",
    queryTermsPlaceholder: "每行一个，或用逗号分隔多个查询词。",
    queryTermsRequired: "至少填写一个查询词后再创建 Topic Watch。",
    seedPapers: "Seed papers",
    seedPapersPlaceholder:
      "可选。每行填写一个论文 ID 或 URL，帮助 watch 沿论文血缘线展开。",
    seedPapersLabel: "Seed papers",
    templateFamily: "模板族",
    schedulePreset: "调度预设",
    enabled: "启用状态",
    enabledDescriptionOn: "该 watch 已启用，可用于后续调度和研究运行。",
    enabledDescriptionOff: "该 watch 会被保存，但当前保持禁用。",
    createButton: "创建 watch",
    creating: "正在创建 watch...",
    createdSuccess: "Topic Watch 已创建",
    createError: "创建 Topic Watch 失败",
    emptyTitle: "还没有 Topic Watch",
    emptyDescription: "先创建第一个 watch，让研究控制平面在工作台里可见。",
    viewDetails: "查看详情",
    detailTitle: "Topic Watch 详情",
    notFoundTitle: "Topic Watch 不可用",
    notFound: "未能加载请求的 Topic Watch。",
    backToBoard: "返回 Board",
    configurationTitle: "配置信息",
    configurationDescription: "这里展示该 watch 当前持久化下来的控制平面配置。",
    metadataTitle: "元数据",
    metadataDescription: "这里保留稳定 ID 与时间戳，方便后续审计研究运行。",
    watchId: "Watch ID",
    createdAt: "创建时间",
    updatedAt: "更新时间",
    none: "无",
    statusEnabled: "已启用",
    statusDisabled: "已禁用",
    templateFamilySolutionPlatform: "方案 / 平台论文",
    templateFamilySurvey: "综述论文",
    scheduleDaily: "每天",
